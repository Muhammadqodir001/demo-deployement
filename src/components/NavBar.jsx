...
const NavBar = () => { 
    ...
    return (
         <div className="absolute w-full flex justify-between p-4 items-center ">
            ...
            <div className={nav ?"fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 py-7 flex-col z-10" : 
               'absolute top-0 h-screen left-[-100%] ease-in duration-300 justify-center '}>
